...
<form class="m-auto w-50" method="post" action="updateVolunteerControler.php">

  <div class="form-group">
    <input type="hidden" class="form-control" id="id" placeholder="" value="<?php echo (isset($volunteer)?$volunteer['id']:"");?>" name="id">
    <div class="">
